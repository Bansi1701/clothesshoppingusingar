...
class CityVO(database.Model):
    ...
    city_name = database.Column('city_name', database.String(100), nullable=False)
    city_description = database.Column('city_description', database.String(100), nullable=False)
